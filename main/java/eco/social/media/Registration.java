...
import eco.social.media.ReusableCode.ReusableCodeForAll;
import eco.social.media.models.Passwords;
import eco.social.media.models.Users;
import eco.social.media.models.privatedetails;

public class Registration extends AppCompatActivity {

    TextView alreadyhaveacc, txt5;
    TextInputLayout Fname,Username, Email, Pass, Mobileno,Gender,Description,Website, Edit_txt;
    EditText Birth;
    String test_edit;
    int year,month,day;
    ...
    HorizontalScrollView teams;
    LinearLayout teams_l;
...
//        Website = (TextInputLayout) findViewById(R.id.website);
        ...
        //teams layouts
        teams = findViewById(R.id.free_teams_scroll);
        teams_l = findViewById(R.id.free_teams_l);
        Edit_txt = (TextInputLayout) findViewById(R.id.edit_txt);
        test_edit = Edit_txt.getEditText().getText().toString().trim();
...
//        useridd = FAuth.getCurrentUser().getUid();
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                test_edit = Edit_txt.getEditText().getText().toString().trim();
                databaseReference.child("name").setValue(test_edit);
            }
        });
                                            ...
                                            FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        builder.setMessage("Registered Successfully,Please Verify your Email, CHECK SPAM");
...
//            isvalidgender = true;}
        ...
        isvalid = (isValidname  && isValidemail && isvalidpassword && isvalidmobileno &&isvalidusername) ? true : false;
        return isvalid;
    }
